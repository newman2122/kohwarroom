...
(() => {
  ...
  async function refreshAllViews() {
    try {
      ...
      UI.toast('Error loading data! Check Firebase rules. ' + err.message, 'error');
    }
  }
  ...
  function _initActivityForm() {
    ...
    form.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        UI.toast('Error saving! Check Firebase rules. ' + err.message, 'error');
      }
    });
  }
  ...
  function _initGatherForm() {
    ...
    form.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        console.error('Gather form error:', err);
        UI.toast('Error saving! Check Firebase rules. ' + err.message, 'error');
      }
    });
  }
  ...
  function _initMobForm() {
    ...
    form.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        console.error('Mob form error:', err);
        UI.toast('Error saving! Check Firebase rules. ' + err.message, 'error');
      }
    });
  }
